...
public class Day04SolverTests
{
    ...
    private const int EXPECTED_ANSWER_ONE = 2; // <--------- solution from web page test example goes here
    private const int EXPECTED_ANSWER_TWO = 4; // <--------- solution from web page test example goes here
