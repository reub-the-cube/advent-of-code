...
public class Day09SolverTests
{
    ...
    private const string EXPECTED_ANSWER_ONE = "114"; // <--------- solution from web page test example goes here
    private const string EXPECTED_ANSWER_TWO = "2"; // <--------- solution from web page test example goes here
