...
{
    private readonly string[] INPUT = File.ReadAllLines(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..", "..", "..", "..", "..", "Inputs", "2023", "day14testinput.txt"));
    private const string EXPECTED_ANSWER_ONE = "136"; // <--------- solution from web page test example goes here
    private const string EXPECTED_ANSWER_TWO = "64"; // <--------- solution from web page test example goes here
