...
{
    private readonly string[] INPUT = File.ReadAllLines(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..", "..", "..", "..", "..", "Inputs", "2023", "day06testinput.txt"));
    private const string EXPECTED_ANSWER_ONE = "288"; // <--------- solution from web page test example goes here
    private const string EXPECTED_ANSWER_TWO = "71503"; // <--------- solution from web page test example goes here
